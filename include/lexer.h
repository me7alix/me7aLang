...
typedef enum {
	TOK_CPAR, TOK_OPAR, TOK_ID, TOK_STRUCT, TOK_ASSIGN, TOK_EXTERN, TOK_STATIC,
	...
	TOK_CSQBRA, TOK_CBRA, TOK_DOT, TOK_PLUS_EQ, TOK_MINUS_EQ, TOK_STAR_EQ, TOK_IMPL,
	...
	TOK_TILDA, TOK_XOR, TOK_MACRO_FUNC, TOK_BLOCK, TOK_ID_CONCAT, TOK_TO_STR,
} TokenKind;
